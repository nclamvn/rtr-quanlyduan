...
export const EMPTY_MESSAGES = {
  vi: {
    ...
    bom: { icon: "Package", title: "Chưa có BOM", desc: "Import danh mục linh kiện từ Excel hoặc AI Import", action: "AI Import" },
    flights: { icon: "Plane", title: "Chưa có bài bay thử", desc: "Import dữ liệu bay thử từ Excel", action: "AI Import" },
    suppliers: { icon: "Truck", title: "Chưa có nhà cung cấp", desc: "Import nhà cung cấp từ Excel", action: "AI Import" },
    decisions: { icon: "Scale", title: "Chưa có quyết định", desc: "Import quyết định từ Excel", action: "AI Import" },
    ...
    orders: { icon: "ShoppingCart", title: "Chưa có đơn hàng", description: "Nhập đơn hàng đầu tiên hoặc import từ Excel", action: "AI Import" },
    production: { icon: "Factory", title: "Chưa có lệnh sản xuất", description: "Tạo lệnh sản xuất từ đơn hàng", action: "AI Import" },
    inventory: { icon: "Warehouse", title: "Chưa có dữ liệu tồn kho", description: "Nhập danh mục linh kiện hoặc import từ Excel", action: "AI Import" },
  ...
  en: {
    ...
    bom: { icon: "Package", title: "No BOM data", desc: "Import bill of materials from Excel or AI Import", action: "AI Import" },
    flights: { icon: "Plane", title: "No flight tests", desc: "Import flight test data from Excel", action: "AI Import" },
    suppliers: { icon: "Truck", title: "No suppliers", desc: "Import suppliers from Excel", action: "AI Import" },
    decisions: { icon: "Scale", title: "No decisions", desc: "Import decisions from Excel", action: "AI Import" },
    ...
    orders: { icon: "ShoppingCart", title: "No orders yet", description: "Create the first order or import from Excel", action: "AI Import" },
    production: { icon: "Factory", title: "No production orders", description: "Create work orders from customer orders", action: "AI Import" },
    inventory: { icon: "Warehouse", title: "No inventory data", description: "Add inventory items or import from Excel", action: "AI Import" },
