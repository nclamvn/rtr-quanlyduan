...
import { FLIGHT_TEST_TYPES, FLIGHT_RESULT_COLORS } from "../data/v2Data";
    ...
    <div style={{ display: "flex", alignItems: "center", gap: 8, padding: "3px 0" }}>
      ...
      <span
        style={{
          fontSize: 12,
          fontFamily: mono,
          color: isWarn ? "#EF4444" : "var(--text-muted)",
          width: 55,
          textAlign: "right",
      ...
      >
        {value}
        {unit} {isWarn && <AlertTriangle size={8} style={{ display: "inline", verticalAlign: "middle" }} />}
      </span>
    </div>
  );
}
...
export default function FlightTestModule({
  lang,
  t: _t,
  project,
  issues: _issues,
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <span style={{ fontSize: 16, fontWeight: 800, color: "var(--text-primary)" }}>
            FLT-{String(ft.testNumber).padStart(3, "0")}
          </span>
        ...
        <div style={{ display: "flex", gap: 12 }}>
          ...
          >
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
              {[
                { icon: Clock, label: lang === "vi" ? "Ngày" : "Date", value: ft.date },
                {
                  ...
                  value: lang === "vi" ? ft.locationVi : ft.location,
                },
            ...
            {ft.autoIssueId && (
              ...
              >
                ...
                <span style={{ fontSize: 12, color: "#FCA5A5" }}>
                  {lang === "vi" ? "Issue tự tạo" : "Auto-created Issue"}:{" "}
                </span>
                <button
                  onClick={() => onViewIssue && onViewIssue(ft.autoIssueId)}
                  style={{
                    background: "none",
                    border: "none",
                    color: "#60A5FA",
            ...
            {!ft.autoIssueId &&
              (ft.result === "FAIL" || ft.result === "PARTIAL") &&
              onCreateAutoIssue &&
              canCreateIssue && (
                <div style={{ marginTop: 10 }}>
                  <button
                    onClick={() => onCreateAutoIssue(ft)}
                    style={{
                      background: "#EF444415",
              ...
              ft.anomalies.map((a, i) => (
                <div
                  ...
                  style={{
                    ...
                    padding: "6px 8px",
                    marginBottom: 4,
                    background: a.severity === "HIGH" ? "#EF444408" : "#F59E0B08",
                    borderLeft: `3px solid ${a.severity === "HIGH" ? "#EF4444" : "#F59E0B"}`,
                    borderRadius: "0 4px 4px 0",
                  }}
                >
                  <span
                    style={{ fontSize: 11, fontFamily: mono, color: "var(--text-dim)", flexShrink: 0, marginTop: 1 }}
                  >
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
      ...
      <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
        ...
        >
          ...
          {["PASS", "FAIL", "PARTIAL", "ABORTED"].map((r) => (
      ...
      >
        ...
        <div style={{ maxHeight: 400, overflowY: "auto" }}>
          {tests.length === 0 && flightTests.length === 0 && (
            <EmptyState
              icon={EMPTY_MESSAGES[lang].flights.icon}
              title={EMPTY_MESSAGES[lang].flights.title}
              description={EMPTY_MESSAGES[lang].flights.desc}
            />
          )}
          {tests.length === 0 && flightTests.length > 0 && (
            <div style={{ padding: 40, textAlign: "center" }}>
              ...
              <div style={{ fontSize: 14, color: "var(--text-faint)" }}>
                {lang === "vi" ? "Không có chuyến bay nào khớp bộ lọc" : "No flights match filters"}
              </div>
              {(filterType !== "ALL" || filterResult !== "ALL") && (
                <button
                  onClick={() => {
          ...
          {tests.map((ft) => (
            <div
              ...
              onMouseEnter={(e) => {
                e.currentTarget.style.background = "var(--border-a20)";
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.background = "transparent";
              }}
            >
              <span style={{ width: 40, fontSize: 13, fontFamily: mono, color: "var(--text-dim)" }}>
                {ft.testNumber}
              </span>
              ...
              <span
                style={{ width: 60, fontSize: 13, fontFamily: mono, color: "var(--text-muted)", textAlign: "right" }}
              >
                {formatDuration(ft.duration)}
              </span>
