...
export const DEMO_CUSTOMERS = [
  {
    ...
    email: "hung.nv@vietnamairlines.com",
    phone: "+84-28-3832-0320",
    country: "Vietnam",
  },
  {
    id: "CUS-002",
    ...
    email: "lan.tt@loctroigroup.com",
    phone: "+84-296-3852-512",
    country: "Vietnam",
  },
  {
    id: "CUS-003",
...
export const DEMO_PRODUCTION_ORDERS = [
  {
    ...
    logs: [
      {
        id: "PL-001",
        station: "PCB Assembly",
        status: "COMPLETED",
        date: "2026-03-05",
        operator: "Văn Hùng",
        notes: "PCB lot A passed all checks",
      },
      {
        id: "PL-002",
        station: "Frame Assembly",
        status: "COMPLETED",
        date: "2026-03-10",
        operator: "Đức Anh",
        notes: "Carbon fiber frame assembled",
      },
      {
        id: "PL-003",
        station: "Motor & ESC",
        ...
        date: "2026-03-15",
        operator: "Thanh Hà",
        notes: "Motor calibration in progress",
      },
    ],
  },
  {
    ...
    logs: [
      {
        ...
        status: "COMPLETED",
        date: "2026-02-20",
        operator: "Lê Thị Phương",
        notes: "Main board + thermal interface",
      },
      {
        id: "PL-005",
        station: "Integration",
        ...
        notes: "LiDAR + thermal camera integrated",
      },
      {
        id: "PL-006",
        station: "QC",
        status: "IN_PROGRESS",
        date: "2026-03-12",
        operator: "Lý Thanh Mai",
        notes: "Final QC inspection",
      },
    ],
  },
];
...
export const DEMO_INVENTORY = [
  {
    id: "INV-001",
    partNumber: "MOT-2806-920",
    name: "Brushless Motor 2806 920KV",
    category: "ELECTRICAL",
    quantity: 24,
    reorderPoint: 10,
    unit: "pcs",
  ...
  {
    id: "INV-003",
    partNumber: "BAT-6S-8000",
    name: "LiPo 6S 8000mAh 25C",
    category: "ELECTRICAL",
    quantity: 6,
    reorderPoint: 5,
    unit: "pcs",
  ...
  {
    id: "INV-005",
    partNumber: "CF-ARM-350",
    name: "Carbon Fiber Arm 350mm",
    category: "MECHANICAL",
    quantity: 40,
    reorderPoint: 16,
    unit: "pcs",
  ...
  {
    id: "INV-006",
    partNumber: "PROP-15X5",
    name: "Propeller 15x5 CF",
    category: "MECHANICAL",
    quantity: 32,
    reorderPoint: 20,
    unit: "pairs",
  ...
  {
    id: "INV-008",
    partNumber: "CAM-SONY-A7R",
    name: "Sony A7R Mapping Camera",
    category: "ELECTRICAL",
    quantity: 2,
    reorderPoint: 2,
    unit: "pcs",
...
export const DEMO_COST_ENTRIES = [
  {
    ...
    projectId: "PRJ-001",
    category: "MATERIALS",
    description: "BOM components batch 1",
    amount: 45000,
    date: "2026-02-15",
    currency: "USD",
  },
  ...
  },
  {
    ...
    projectId: "PRJ-004",
    category: "MATERIALS",
    description: "Inspector BOM + thermal",
    amount: 38000,
    date: "2026-02-01",
    currency: "USD",
  },
  {
    ...
    projectId: "PRJ-004",
    category: "TESTING",
    description: "IP67 certification + DVT tests",
    amount: 12000,
    date: "2026-01-20",
    currency: "USD",
  },
